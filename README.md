...
<body>
  ...
  <img id="friendPhoto" src="img/364275763_1694049317705305_3363139715318599224_n.jpg" alt="เพื่อน" />
  <h1>สุขสันต์วันเกิด ปอย 🎉</h1>
  ...
  <script>
    ...
    music.addEventListener("ended", () => {
      ...
      floating.textContent = "🎂 สุขสันต์วันเกิด ปอย! You’re older today than yesterday but younger than tomorrow, Happy birthday.🎉";
